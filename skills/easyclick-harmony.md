---
name: easyclick-harmony
description: EasyClick鸿蒙Next自动化开发Skill，唯一运行模式USB HID，包含HID初始化流程、节点+HID点击、图色识别、OCR/YOLO等鸿蒙特有内容。当用户进行鸿蒙平台EC开发时使用。
---
...
**开发步骤**：
1. **环境准备**
   - 安装IntelliJ IDEA（推荐 **2026.2 及以上**：无需激活 IDEA，直接安装开发插件即可使用）+ EasyClick插件
