---
name: easyclick-android
description: EasyClick安卓自动化开发Skill，包含双平面架构、五种运行模式（无障碍/代理/Root/蓝牙HID/OTG HID）、CLI工具链、XML UI规范、常用函数速查等安卓特有内容。当用户进行安卓平台EC开发时使用。
---
...
- 推荐 IDEA **2026.2 及以上**：无需激活 IDEA，直接安装开发插件即可使用
- 连接手机、下发/停止脚本、编译打包
- 抓取界面信息、输出引擎/插件日志
