---
title: Keyboard input code table
description: EasyClick automation scripts — jailbreak-free iOS keyboard input code table
keywords:
 - EasyClick automation scripts jailbreak-free iOS keyboard input code table
 - eventPageID
 - eventUsageID
 - x0C
 - x07
...
These values simulate keyboard input. Parameters are **eventPageID** and **eventUsageID**. There is no deeper meaning to the pair — use the values as documented.
...
eventUsageID = copied from source; behavior may vary — test on your target
