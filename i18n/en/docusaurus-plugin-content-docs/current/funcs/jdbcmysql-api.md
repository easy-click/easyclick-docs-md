...
description: EasyClick automation scripts — Android no root JDBC MySQL functions
keywords:
 - EasyClick automation scripts Android no root JDBC MySQL functions
 - jdbc
 - JDBC
 - init
 - param
...
- The JDBC module supports MySQL 5.x; MySQL 8.0+ is not supported
...
* @return `{bool}` true on success, false on failure
 :::tip
 - A common mistake is using 127.0.0.1 or localhost, which causes connection failures
 - 127.0.0.1 is the device itself, not your development PC — use your PC LAN IP address
 :::
