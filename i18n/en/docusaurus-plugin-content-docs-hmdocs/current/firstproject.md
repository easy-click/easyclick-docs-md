---
title: First project
description: EasyClick HarmonyOS Next — create and connect your first project
...
:::tip
- Download the latest plugin from the cloud drive: **HarmonyOS Next resources → Dev plugin**
:::
