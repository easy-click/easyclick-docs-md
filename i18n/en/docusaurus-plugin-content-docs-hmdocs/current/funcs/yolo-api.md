...
description: EasyClick automation scripts — HarmonyOS Next automation YOLO functions
keywords:
 - EasyClick automation scripts HarmonyOS Next automation YOLO functions
 - yolov8
 - Yolov8Util
 - onnx
 - yolov8Api
