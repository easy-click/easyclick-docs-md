...
description: EasyClick automation scripts — HarmonyOS Next automation network functions
keywords:
 - EasyClick automation scripts HarmonyOS Next automation network functions
 - http
 - br
 - GET
 - JSON
...
* See [example](/hmdocs/funcs/http-api#httpnewwebsocket-websocket-communication)
