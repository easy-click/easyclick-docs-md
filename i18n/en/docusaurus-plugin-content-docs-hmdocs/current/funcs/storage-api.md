...
description: EasyClick automation scripts — HarmonyOS Next automation storage functions
keywords:
 - EasyClick automation scripts HarmonyOS Next automation storage functions
 - storage
 - key
 - param
 - return
