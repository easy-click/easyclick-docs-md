...
description: EasyClick automation scripts — HarmonyOS Next automation JDBC MySQL functions
keywords:
 - EasyClick automation scripts HarmonyOS Next automation JDBC MySQL functions
 - jdbc
 - JDBC
 - param
 - init
