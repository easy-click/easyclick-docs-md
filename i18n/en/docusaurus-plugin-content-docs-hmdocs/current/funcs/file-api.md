...
description: EasyClick automation scripts — HarmonyOS Next automation file functions
keywords:
 - EasyClick automation scripts HarmonyOS Next automation file functions
 - file
 - getSandBoxDir
 - getSandBoxFilePath
 - readFile
