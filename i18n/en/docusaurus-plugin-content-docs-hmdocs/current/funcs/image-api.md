...
description: EasyClick automation scripts — HarmonyOS Next image and color functions
keywords:
 - EasyClick automation scripts HarmonyOS Next image and color functions
 - image
 - param
 - useOpencvMat
 - setInitParam
...
* Grayscale image
* Requires EC HarmonyOS Next USB 2.9.0+
...
* Read image at path and return ```{@link AutoImage}```, or null if missing or undecodable
* @param path Image path
* @return Java BufferedImage or null
...
* @param w Clip width
* @param h Clip height
* @return `{Bitmap}` Java BufferedImage object
