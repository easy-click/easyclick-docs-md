---
title: EasyClick automation — iOS — Code obfuscation
hide_title: false
...
## Getting started
- After upgrading the EC iOS IDEA plugin to 5.0.0+, an `obfuscator.json` file is created under the project module
