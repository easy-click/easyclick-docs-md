...
:::
## 下载主程序
- 到[**资源区网盘**](/iostjdocs/zh-cn/tools/download_resources)下载主程序压缩包 
...
- 参考-->[**文字教程**](/iostjdocs/zh-cn/advance/tjcenter)
...
- 签名参考-->[**苹果IPA签名教程**](http://laoleng.vip/docs/tools/easyclick/ipasign/)
- 如果是MacOS开发者,可以使用代理程序的源码，xcode编译运行到手机,此时支持个人免费开发者账号签名,参考USB版的-->[**MacOS源码编译**](/iosdocs/zh-cn/tools/signagent#macos源码编译)
