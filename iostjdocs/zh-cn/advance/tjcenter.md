...
:::tip USB激活方式视频教程
- 地址： https://www.bilibili.com/video/BV1Ysgr6YELZ
:::
...
:::tip 新版本（10.2.0+）
全新脱机激活器客户端已上线，USB 连接设备后直接在中控点击「脱机激活器」→「全新界面」即可使用，无需配置桥接地址或浏览器访问。详见 → [**脱机激活器使用教程**](/iosdocs/zh-cn/advance/ios-usb-activator)
:::
...
- 使用桥接程序进入
    ...
    - 注意：新版本windows弹窗提示【程序已启动，并已在托盘运行】，你可以直接去【托盘】点击EasyClick的图标,选择【打开脱机激活器】
