...
:::tip 新版本（10.2.0+）
全新脱机激活器客户端已上线，USB 连接设备后直接在中控点击「脱机激活器」→「全新界面」即可使用，无需配置桥接地址或浏览器访问。详见 → [**脱机激活器使用教程**](/iosdocs/advance/ios-usb-activator)
:::
...
- 脱机版本中控投屏系统
    ...
    - **建议直接使用该激活器**:[脱机版本中控投屏系统](/iostjdocs/funcs/tjcenter/)
- 网盘地址请看资源区 [教程资源区](/iostjdocs/tools/download_resources)
...
- iOS17+ 需要安装usbncm驱动，请参考 USB版本的 [iOS17使用说明](/iosdocs/otherinc/ios17)，或者使用爱思最新版本进行实时投屏一次
