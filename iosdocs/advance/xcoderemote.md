...
keywords:
  - EasyClick 自动化脚本 iOS免越狱 远程安装IPA
  - xcode
  - image
  - Xcode
  - img
...
- 以上动作都完成后，进入[安装代理IPA](/iosdocs/tools/signagent)流程，就可以看到远程的手机了，按照正常的安装流程即可远程安装IPA
...
- 如果远程连接不上会有链接失败字样
- 所有端启动后，正常进入[安装代理IPA](/iosdocs/tools/signagent)流程，就可以看到远程的手机了，按照正常的安装流程即可远程安装IPA
