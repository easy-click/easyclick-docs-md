...
* 典型用途：配合 `auxEvent.agentDumpXml()` 在 WiFi 场景下使用 [节点函数](./node-api.md) 的选择器
...
完整说明见 [节点函数 - lockNodeFromXml](./node-api.md#locknodefromxml-从-xml-锁定节点)；配套 Aux 接口见 [agentDumpXml](./aux-event-api.md#agentdumpxml)。
