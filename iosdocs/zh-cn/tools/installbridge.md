...
- 请到[资源区的网盘](/iosdocs/zh-cn/tools/download_resources)，下载桥接程序
- 该程序支持Windows，macos，linux等系统
- 请下载对应的版本, 解压, 解压路径不能包含空格/特殊符号/括号等
- IOS17以下系统需手动放入开发者镜像到 `config\DeveloperDiskImage` ,方法参考-->[下载开发者镜像](/iosdocs/zh-cn/tools/installcenter#下载开发者镜像可选)
