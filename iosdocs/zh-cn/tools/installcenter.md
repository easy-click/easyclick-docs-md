...
:::tip 10.2.0 新版说明
10.2.0 版本启用了全新界面架构，启动更快、布局更清晰，同时内置了集控投屏和脱机激活器入口。基本操作流程与旧版一致，下载路径请将版本号替换为 `v10.2.0`。新版本详细说明请参考 → [**投屏操作教程**](/iosdocs/zh-cn/advance/ios-usb-screen)
:::

## 下载中控
- 请到[资源区的网盘](/iosdocs/zh-cn/tools/download_resources)，下载中控程序
...
- 请到[资源区的网盘](/iosdocs/zh-cn/tools/download_resources)，下载中控程序 **EC开发包-->IOS资源-->开发者镜像-DeveloperImage12.4-26.0.zip**
