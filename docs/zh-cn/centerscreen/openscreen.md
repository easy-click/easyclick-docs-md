...
- USB-HID的配置推荐使用Linux主机带机[USB-HID主机配置](http://localhost:3000/docs/zh-cn/centerscreen/hidlinux)
- 蓝牙HID请参考[蓝牙HID硬件教程](/docs/zh-cn/advance/blehid)，配置好了之后再进行操作
- OTG-HID请参考[OTG-HID硬件教程](/docs/zh-cn/advance/otghid)
...
### USB HID模式点击
- USB HID不用开启无障碍、USB调试模式，这里推荐使用 `Linux系统 进行安装 HID主控程序`，具体请看 [HID小主机](/docs/zh-cn/centerscreen/hidlinux)
