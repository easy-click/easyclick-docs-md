...
---
:::info 一句话摘要（TL;DR）
本页带你用 IDEA 创建第一个 EasyClick **安卓脚本工程**：安装插件 → 建工程 → USB 连接设备 → 激活并运行。安卓自动化**无需 root**；推荐 IDEA 2026.2+（安装插件后无需激活 IDEA）。
:::
...
# 第一个脚本工程
## 下载开发工具
- 下载开发工具 : [点我下载](tools/download_resources.md)    
...
- **推荐下载 IDEA 2026.2 及以上版本：无需激活 IDEA，直接安装开发插件即可使用**
