...
### image.captureScreenshot 代理截图

* 代理截图：SurfaceControl截图，返回 AutoImage
* 非代理模式回退为 captureFullScreen。
* 兼容EC 安卓 12.4.0+
* @return AutoImage对象或者null
...
function main() {
  ...
  // PP-OCRv6，需 Android 8.0(API26)+，默认 modelTier=small
...
### image.captureScreenSurface 代理截图

* 代理截图：底层 SurfaceControl，返回 AutoImage。
* 非代理模式回退为 captureFullScreen
* 兼容EC 安卓 12.4.0+
* @return AutoImage对象或者null
