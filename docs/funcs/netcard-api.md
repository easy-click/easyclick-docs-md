...
keywords:
  - EasyClick 自动化脚本 android免root 网络验证函数
  - ecNetCard
  - id
  - http
  - uc
...
- 网络验证平台用法说明: [点我查看](/docs/advance/netcard)

## 卡密相关

### ecNetCard.setDeviceId 自定义设备id

* [网络验证]自定义设备id
* 提卡网址 [http://uc.ieasyclick.com]
* 适配版本 EC 安卓 11.21.0+
* @param deviceId 自定义的设备id, 自己生成的设备id，不得超过32个字符
...
function main() {
    ...
    logd("开始执行脚本...")
    // 这个只是例子 不要 照搬，你可以使用android_id代替或者自己生成
